> root directory is `~/code/learnit`\
...
│   ├── config.toml
│   ├── migrations
│   │   ├── 20241009113004_recreate_database_structure.sql
│   │   ├── v1_20240929143053_remote_schema.sql
│   │   └── v2_20241009113004_recreate_database_structure.sql
│   └── seed.sql
├── tailwind.config.mjs
├── tests
│   └── example.spec.ts
